...
using BuisinessLayer.Implementations;
...
namespace FinalTask
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ILectorsRepository, EFLectorsRepository>();
            services.AddTransient<ILecsRepository, EFLecsRepository>();
            services.AddTransient<IAttendancesRepository, EFAttendancesRepository>();
